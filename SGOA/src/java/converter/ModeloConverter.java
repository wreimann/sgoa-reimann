...
public class ModeloConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        try {
            ...
            Logger.getLogger(ModeloConverter.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        } finally {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Modelo) {
            ...
            throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ModeloController.class.getName());
        }
    }
}
